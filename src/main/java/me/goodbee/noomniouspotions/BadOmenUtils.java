...
public class BadOmenUtils {
    public static void applyBadOmen(LivingEntity livingEntity) {
        ...
        if(existingPotionEffect.getAmplifier() < 4) {
        ...
        NoOmniousPotions.getInstance().getLogger().info(String.format("Reapplying Bad Omen 5 to %s", livingEntity.getName()));
        applyBadOmen(livingEntity, 4);
    }
